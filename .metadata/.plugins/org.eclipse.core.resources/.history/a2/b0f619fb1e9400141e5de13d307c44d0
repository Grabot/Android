package onzichtbaar.net.greaterThanFive6;

import java.util.ArrayList;

import onzichtbaar.net.greaterThanFive6.gameScreen.GameScreen;
import onzichtbaar.net.greaterThanFive6.load.Screen;
import onzichtbaar.net.greaterThanFive6.load.Vector;
import onzichtbaar.net.greaterThanFive6.objects.Citizen;
import onzichtbaar.net.greaterThanFive6.townScreen.TownScreen;
...
public class Main implements ApplicationListener, InputProcessor
{
	...
	public void create()
	{
    	...
    	citizens.add(new Citizen( "Anne", 19, 100, "unemployed" ));
    	citizens.add(new Citizen( "Sanne", 26, 100, "unemployed" ));
    	citizens.add(new Citizen( "Eva", 19, 100, "unemployed" ));
    	citizens.add(new Citizen( "Celine", 19, 100, "unemployed" ));
    	citizens.add(new Citizen( "Kim", 22, 100, "unemployed" ));
    	citizens.add(new Citizen( "Rachel", 25, 100, "unemployed" ));
    	citizens.add(new Citizen( "Evelien", 23, 100, "unemployed" ));
    	citizens.add(new Citizen( "Lynne", 21, 100, "unemployed" ));
    	/*
    	 */
	...
	public void render() 
	{
		...
		if (screen.isDone( ))
	    {
	        ...
	        {
	        	screen = new TownScreen( Gdx.app, camera, stage, batch, screen.citizens() );
	        }
	    }
